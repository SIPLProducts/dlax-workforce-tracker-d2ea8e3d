  ...
  return (
    <div className="space-y-6">
      ...
      <Card><CardContent className="p-0">
        <Table>
          <TableHeader className="[&_th]:sticky [&_th]:top-[110px] md:[&_th]:top-[126px] [&_th]:z-[5] [&_th]:bg-card [&_th]:shadow-[0_1px_0_0_hsl(var(--border))]"><TableRow><TableHead>Name</TableHead><TableHead className="w-32">Group</TableHead><TableHead className="w-24">Order</TableHead><TableHead className="w-24">Actions</TableHead></TableRow></TableHeader>
          <TableBody>
            {filtered.map((d) => (
              <TableRow key={d.id}>
